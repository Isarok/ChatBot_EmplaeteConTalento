  ...
  return (
    <section className="font-sans lgl:w-1/3 lg:w-1/2 backdrop-blur-2xl pt-5 flex flex-col rounded-lg border border-gray-300">
      <div className="flex flex-col gap-3">
        <h1 className=" text-xl text-center text-slate-300 font-bold ">¿PREPARAD@?</h1>
        <div className="flex lgl:flex-row lg:flex-row md:flex-row flex-col items-center sm:items-center sm:justify-start p-5">
          ...
          <div className="ml-4">
            <h1 className="text-left text-xl text-slate-300 font-semibold max-w-xs">JUEGO DE CV</h1>
            <p className="text-sm text-slate-300 font-semibold max-w-xs">Descubre si tu currículum está bien elaborado</p>
          </div>
        </div>
        <div className="flex lgl:flex-row lg:flex-row md:flex-row flex-col items-center sm:items-center sm:justify-start p-5">
          ...
          <div className="ml-4">
            <h1 className="text-left text-xl text-slate-300 font-semibold max-w-xs">JUEGO DE COMPETENCIAS</h1>
            <p className="text-sm text-slate-300 font-semibold  max-w-xs">Descubre los talentos que desarrollas con tus hobbies</p>
          </div>
        </div>
        <div className="flex lgl:flex-row lg:flex-row md:flex-row flex-col items-center sm:items-center sm:justify-start p-5">
          ...
          <div className="ml-4">
            <h1 className="text-left text-xl text-slate-300 font-semibold max-w-xs">JUEGO DE EMPRENDIMIENTO</h1>
            <p className="text-sm text-slate-300 font-semibold max-w-xs">Descubre si tienes cualidades para emprender</p>
          </div>
        </div>
      </div>
    </section>

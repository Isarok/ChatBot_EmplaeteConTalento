const Banner = () => {
  return (
    <div className="lgl:fixed top-0 right-0 bottom-0 w-96 lg:mt-20 sm:mt-0 h-screen before:z-10 mx-auto sm:w-full sm:block md:w-1/4 lg:block lg:w-1/4 md:hidden">
